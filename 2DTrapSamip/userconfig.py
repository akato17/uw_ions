...
tstep= basetstep*3 #need smaller tstep for two step process, for psuedo
...
'''Field Voltages'''
VOLT0and4=np.load('VOLT0and4.npy')
VOLT1and5=np.load('VOLT1and5.npy')
VOLT2and6=np.load('VOLT2and6.npy')
VOLT3and7=np.load('VOLT3and7.npy')
VOLT8and9=np.load('VOLT8and9.npy')