# -*- coding: utf-8 -*-
"""
Created on Thu Aug 12 19:57:41 2021

@author: samip
"""

'''same as 'laser' but I can change the parameters of this one so that 
the detuning of the laser makes it heat up rather than cool'''
import numpy as np
from mdconst import *
...
#laser direction #counter progating to laser 1
dx=-1
dy=0
#dy=0
dz=0.172793
...
#laser parameters
wlaser= watom+0.5*gamma# make sure delta is positive, delta= laser-atom
...
delta=wlaser-0.5*watom #wlaser-watom
